/*
 ...
 Teensy 3 Variant of MPU9250 named MPU9250_t3.
 This use the T3 version of wire.h named i2c_t3.h
 */
#ifndef _MPU9250_t3_H_
#define _MPU9250_t3_H_

#include <SPI.h>
//#include <Wire.h>
//#include "i2c_t3.h" // this is Teensy 3 version of wire.h 
...
class MPU9250
{
  ...
  public:
	...
	float MagneticBearingFiltered;
	float RateGyroCalibrationFactor = 0.95;
	float GyroBearing;
	float GyroBearingFiltered;
	float HDG;
	bool  MagneticCompassCalibrationMode = false;
